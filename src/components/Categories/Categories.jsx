    ...
    return (
        <div className="Categories">
            <div className="col">
                ...
                <a href="https://e-comm-client-eosin.vercel.app/products/">
                    
                    <img src="img/categories/itguy1.jpg" width={320} alt="itguy1"></img>
                </a>
                </div>
                <div className="row">
                ...
                <a href="https://e-comm-client-eosin.vercel.app/products/">
                    ...
                    <img src="img/categories/itguy2.jpg" alt="itguy2"></img>
                </a>
                </div>
            </div>
            <div className="col">
                ...
                <a href="https://e-comm-client-eosin.vercel.app/products/">
                    ...
                    <img src="img/categories/itgirl2.jpg" alt="itgirl2"></img>
                </a>
                </div>
            </div>
            <div className="col col-l">
                 <div className="row">
                    <div className="col">
                        ...
                        <a href="https://e-comm-client-eosin.vercel.app/products/">
                            ...
                            <img src="img/categories/sweats.jpg" width={506} alt="sweats"></img>
                        </a>
                        </div>
                    </div>
                 </div>
                 <div className="row">
                    ...
                    <a href="https://e-comm-client-eosin.vercel.app/products/">
                    <img src="img/categories/accessories.jpg" height={325} width={506} alt="accessories"></img>
                    </a>
                 </div>
            </div>
        </div>
